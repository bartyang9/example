...
int main() {
    ...
    dart::HostOnlyModel val_torso = dart::readModelURDF(objectModelFile, "link1", "obj", colour_estimated_model);
...
//                            true,videoLoc+"/color",dart::IMAGE_PNG,320,240);
    ...
    // add baxter
    // dart::HostOnlyModel spaceJustin = dart::readModelURDF(urdf_model_path, "base");

    // std::cout<<"found robot: "<< spaceJustin.getName()<<std::endl;
    ...
    tracker.addModel(val_torso,//objectModelFile,
